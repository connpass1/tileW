...
export default function Home(){
 ...
 <main className="bg-white dark:bg-gray-900 h-full center">
 <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <Link href="/" className="inline-flex text-white bg-primary  hover:bg-primary_light   focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary_dark my-4">

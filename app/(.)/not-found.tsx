...
const Error404: React.FC = () =>  <div className= "font-font2 m-8 flex items-center justify-center w-full  flex-col col-span-full row-span-full gap-12  text-slate-800 dark:text-slate-300 p-8 text-center" >  

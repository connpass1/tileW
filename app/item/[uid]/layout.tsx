...
export default function Layout({
  ...
  return (
    <>
      <div className="breadcrumb max-2xl:pr-4">
      ...
      <div className="col-span-full  flex h-12 items-center justify-between text-2xl  max-2xl:pr-4 max-xl:pl-4">
        {rate}
      </div> 
      ...
      <span className="col-span-full max-2xl:pr-4 max-xl:pl-4 xl:py-4 ">{description}</span>

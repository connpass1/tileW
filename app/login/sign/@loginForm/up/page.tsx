...
export default function Page() {
  ...
  return (
    <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <input
        ...
        className="focus:ring-primary-600 focus:border-primary-600 block w-full rounded-lg border border-slate-300 bg-slate-50 p-2.5 font-mono text-slate-900 dark:border-slate-600 dark:bg-slate-700 dark:text-white dark:placeholder-slate-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 sm:text-sm"
 ...
 <label
      htmlFor="password1"
      className="mb-2 block text-sm font-medium text-right font-sans"
    >
      Password repeat
    </label>
    <input
